...
<head>
  ...
  <link rel="apple-touch-icon" href="../../apple-touch-icon.png"><script defer src="../../analytics.js"></script>
  ...
  <meta property="og:image" content="https://www.weathertell.com/logo.png">
...
<body data-location-name="${city}" data-location-region="${region}" data-latitude="${latitude}" data-longitude="${longitude}">
  ...
  </main><footer class="site-footer"><div class="footer-top"><div class="footer-brand"><a class="footer-logo" href="../../"><img src="../../logo.png" alt=""><span>weather<span class="brand-dot">tell</span></span></a><p>Clear weather forecasts for any place in the world, up to 14 days ahead.</p></div><nav class="footer-col" aria-label="Navigation"><h3>Navigation</h3><a href="../../">Forecast</a><a href="../../locations/">Locations</a><a href="../../blog/">Weather Explained</a></nav></div><div class="footer-bottom"><span>© 2026 WeatherTell.com</span><span>Data from <a href="https://open-meteo.com" rel="noopener" target="_blank">Open-Meteo</a></span><a href="#" class="cookie-settings-link">Cookie settings</a><a href="../../privacy/">Privacy Policy</a></div></footer></div><script src="../../app.js"></script>
</body></html>`;
};
...
fs.writeFileSync(path.join(root, 'locations', 'index.html'), `<!doctype html><html lang="en"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><link rel="icon" type="image/png" href="../favicon.png"><link rel="apple-touch-icon" href="../apple-touch-icon.png"><script defer src="../analytics.js"></script><meta name="theme-color" content="#0a2a5c"><title>Weather forecast by location | WeatherTell.com</title><meta name="description" content="Browse the weather forecast for major cities around the world."><link rel="canonical" href="https://www.weathertell.com/locations/"><meta property="og:type" content="website"><meta property="og:locale" content="en_GB"><meta property="og:site_name" content="WeatherTell.com"><meta property="og:title" content="Weather forecast by location | WeatherTell.com"><meta property="og:description" content="Browse the weather forecast for major cities around the world."><meta property="og:url" content="https://www.weathertell.com/locations/"><meta property="og:image" content="https://www.weathertell.com/logo.png"><meta name="twitter:card" content="summary_large_image"><meta name="twitter:title" content="Weather forecast by location | WeatherTell.com"><meta name="twitter:description" content="Browse the weather forecast for major cities around the world."><meta name="twitter:image" content="https://www.weathertell.com/logo.png"><link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link href="https://fonts.googleapis.com/css2?family=Manrope:wght@400;500;600;700;800&family=Plus+Jakarta+Sans:wght@500;600;700;800&display=swap" rel="stylesheet"><link rel="stylesheet" href="../styles.css"><script type="application/ld+json">${locationsBreadcrumbSchema}</script></head><body><div class="page-shell"><header class="site-header"><a class="brand" href="../" aria-label="WeatherTell.com home"><img class="brand-logo" src="../logo.png" alt=""><span>weather<span class="brand-dot">tell</span></span></a><nav class="top-nav" aria-label="Main navigation"><a href="../">Forecast</a><a href="../blog/">Weather Explained</a><a class="active" href="./">Locations</a></nav><details class="mobile-menu"><summary aria-label="Open navigation"><span class="menu-icon" aria-hidden="true">☰</span><span>Menu</span></summary><div><a href="../">Forecast</a><a href="../blog/">Weather Explained</a><a href="./">Locations</a></div></details></header><nav class="breadcrumbs" aria-label="Breadcrumb"><a href="../">Forecast</a><span class="sep">/</span><span class="crumb-current" aria-current="page">Locations</span></nav><main><section class="location-directory"><p class="section-kicker">worldwide</p><h1>Weather forecast<br><em>by location</em></h1><p>Browse the current weather and 14-day forecast for major cities around the world.</p><div class="directory-filter"><label class="directory-search" for="directorySearch"><span class="search-icon" aria-hidden="true">⌕</span><input id="directorySearch" type="search" autocomplete="off" placeholder="Search a city, e.g. Berlin"></label><div class="letter-filter" id="letterFilter" role="group" aria-label="Filter by letter"><button type="button" class="letter-chip active" data-letter="">All</button>${letterChips}</div></div><div class="directory-links" id="directoryLinks">${links}</div><p class="directory-empty" id="directoryEmpty" hidden>No locations found for this search.</p></section></main><footer class="site-footer"><div class="footer-top"><div class="footer-brand"><a class="footer-logo" href="../"><img src="../logo.png" alt=""><span>weather<span class="brand-dot">tell</span></span></a><p>Clear weather forecasts for any place in the world, up to 14 days ahead.</p></div><nav class="footer-col" aria-label="Navigation"><h3>Navigation</h3><a href="../">Forecast</a><a href="./">Locations</a><a href="../blog/">Weather Explained</a></nav></div><div class="footer-bottom"><span>© 2026 WeatherTell.com</span><span>Data from <a href="https://open-meteo.com" rel="noopener" target="_blank">Open-Meteo</a></span><a href="#" class="cookie-settings-link">Cookie settings</a><a href="../privacy/">Privacy Policy</a></div></footer></div>${directoryScript}</body></html>`, 'utf8');
